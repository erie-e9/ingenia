...
const react_hook_form_1 = __importDefault(require("react-hook-form"));
const axios_1 = __importDefault(require("axios"));
const FormContent = () => {
    const { register, handleSubmit, watch, errors } = react_hook_form_1.default();
    // @ts-ignore
    const onSubmit = data => {
        const dataobj = {
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                    <div className="fiels-wrapper">
                        ...
                        <div className="tellus-wrapper">
                            ...
                            <div className="form-input-wrapper">
                                <textarea ref={register({ required: true, minLength: 5 })} name="comment" wrap="hard" autoComplete="off">
                                </textarea>
